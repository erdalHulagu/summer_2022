...
public class Q20_switchCase {


    //ondalik ve yuzdelikler boyle hesaplanir    interwiuv sorusu
    // ONEMLI
    // birler=sayi%10;
    //onlar=(sayi%100)/10;
    //yuzler=sayi/100;
    public static void main(String[] args) {
        ...
        System.out.println("3 basamakli bir ayi giriniz");
        int sayi = scan.nextInt();

        int birlerBasmagi = (sayi % 10), onlarBasamagi = (sayi / 10) % 10, yuzlerBasamagi = sayi / 100;
