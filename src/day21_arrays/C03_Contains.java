...
public class C03_Contains {
    public static void main(String[] args) {
       // Soru 3- Kullanicidan aldiginiz bir ismiin verilen Array'de
        // istenen bir elemani icerip icermedigini kontrol edip, bize true
        //veya false sonucu donen bir method olusturun.
