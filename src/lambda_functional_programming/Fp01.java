...
public class Fp01 {
    ...
    2) Functional Programming'de "ne yapilacak" (what to do) uzerinde yogunlasilir.
    ...
    4) entrySet() methodu ile Map. Set'e donusturelerek Functional Programming'de kullanilabilir
